...
//    'filterModel' => $searchModel,
    'columns' => [
        ...
        'panel' => [
            ...
            'type' => 'info',
            'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> Add', ['create'], ['class' => 'btn btn-success']), 'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset List', ['search/by-skill'], ['class' => 'btn btn-info']),
            'showFooter' => false
        ],
]);
Pjax::end();
