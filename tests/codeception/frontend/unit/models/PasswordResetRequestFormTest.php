...
class PasswordResetRequestFormTest extends DbTestCase
{
    ...
    {
        $this->specify('no user with such email, message should not be send',
            function () {
        ...
        $this->specify('user is not active, message should not be send',
            function () {
    ...
    public function testSendEmailCorrectUser()
    {
        ...
        $this->specify('message has correct format',
            function () use ($model) {
